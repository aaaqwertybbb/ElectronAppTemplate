...
contextBridge.exposeInMainWorld('myAPI', {
  ...
  */
  ...
  findAll: (search: string, matchWord: boolean) => ipcRenderer.invoke('find-all', search, matchWord),
  findAllGetPositions: (absolutePath: string, search: string, matchWord: boolean) => ipcRenderer.invoke('find-all-getPositions', absolutePath, search, matchWord),
